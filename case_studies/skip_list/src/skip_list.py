"""Implementation of the randomized data structure skip list.
Testing of the implementation can be run using pytest. Mutation testing using
mutmut can also be performed. For this, some lines of codes are excluded
from the mutation, marked by: # pragma: no mutate.
