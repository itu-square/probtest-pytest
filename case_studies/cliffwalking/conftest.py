...
def pytest_addoption(parser):
    ...
    parser.addoption(
        ...
        help="Sample numbers for estimation"
    )
...
def pytest_configure(config):
    ...
    # Dynamically import test_cartpole.py
    test_path = Path(__file__).parent / "test_cliffwalking.py"
    spec = importlib.util.spec_from_file_location("test_cliffwalking", str(test_path))
    test_mod = importlib.util.module_from_spec(spec)
    sys.modules["test_cliffwalking"] = test_mod
